...
category.add("Empacados", "empacados");
item.add("Bocatto", "", 5000, "bocatto.jpg", "empacados");
item.add("Chococono", "", 3500, "chococono.png", "empacados");
item.add("Chococono + flow", "", 4000, "chococono+flow.jpg", "empacados");
item.add("Chococono Bakano", "", 4000, "bakano.jpg", "empacados");
item.add("Aloha Raspado", "", 4500, "raspado.jpg", "empacados");
item.add("Vaso Kids", "", 3500, "vaso-kids.png", "empacados");
item.add("Paleta Kids", "", 2000, "kids.jpg", "empacados");
item.add("Casero", "", 3500, "casero.jpg", "empacados");
item.add("Artesanal", "", 3500, "artesanal.jpg", "empacados");
item.add("Polet", "", 5000, "polet.jpg", "empacados");
item.add("Polet Grande", "", 6000, "polet-grande.jpg", "empacados");
item.add("Platillo", "", 3500, "platillo.jpg", "empacados");
item.add("Jet", "", 4500, "jet.png", "empacados");
item.add("Paleta Aloha Mix", "", 3500, "aloha-mix.jpg", "empacados");
